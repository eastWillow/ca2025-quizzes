/*
gcc -O0 -fprofile-arcs -ftest-coverage clz_loop.c -o clz_loop &&\
./clz_loop &&\
gcov -o clz_loop clz_loop.c &&\
...
int main(void)
{
    ...
    uint32_t expect_values[] = {32, 31, 30, 28, 27, 24, 16, 8, 4, 3, 0, 0};
    ...
    for (int i = 0; i < num_tests; i++) {
        ...
        unsigned b = expect_values[i];
        // printf("x = 0x%08X, clz_loop = %u, clz_bitwise = %u\n", x, a, b);
        printf("x = 0x%08X, clz_loop = %u, expected = %u\n", x, a, b);
        assert(a == b);
    }
